...
{
    void BeginSelection(Word w);
    void ContinueSelection(Word w);
    void EndSelection();
}

public class WordSearchPuzzle : MonoBehaviour, IPuzzleManager
{
    public static WordSearchPuzzle Instance;
    ...
    [Header("Matched Prefab Settings")]
